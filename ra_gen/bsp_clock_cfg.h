...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(120,0) /* PLL2 Mul x120-139|Mul x120|PLL2 Mul x120.00 */
...
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_5) /* PLL2Q Div /5 */
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (0) /* PLL2Q 0Hz */
#define BSP_CFG_PL2ODIVR (BSP_CLOCKS_PLL_DIV_3) /* PLL2R Div /3 */
